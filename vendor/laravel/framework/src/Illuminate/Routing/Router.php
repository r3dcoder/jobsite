...
class Router implements BindingRegistrar, RegistrarContract
{
    ...
    public function auth(array $options = [])
    {
        ...
        if ($options['register'] ?? true) {
            $this->get('company/register', 'Auth\RegisterController@showRegistrationForm')->name('company_register');
            $this->post('company/register', 'Auth\RegisterController@register');

            $this->get('applicant/register', 'Auth\RegisterController@showRegistrationForm2')->name('registerApplicant');
            $this->post('applicant/register', 'Auth\RegisterController@registerApplicant');
        }
